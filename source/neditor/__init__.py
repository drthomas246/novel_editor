...
from . import cw as CreateWindow
from . import ep as EventProcessing
from . import sp as SubfunctionProcessing
from . import hp as HighlightProcessing
from . import fp as FindProcessing
from . import cp as ComplementProcessing
from . import fm as FileMenu
from . import em as EditMenu
from . import hm as HelpMenu
...
def window_create(locale_var, TREE_FOLDER, tokenizer, wiki_wiki, VERSION):
    ...
    class_instance = {
        'cw': CreateWindow,
        'ep': EventProcessing,
        'sp': SubfunctionProcessing,
        'hp': HighlightProcessing,
        'fp': FindProcessing,
        'cp': ComplementProcessing,
        'fm': FileMenu,
        'em': EditMenu,
        'pm': ProcessingMenu,
        'lm': ListMenu,
